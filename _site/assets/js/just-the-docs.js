...
function initSearch() {
  ...
  request.open('GET', '/twilight-sword-traducao/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/twilight-sword-traducao/assets/css/just-the-docs-' + theme + '.css');
}
